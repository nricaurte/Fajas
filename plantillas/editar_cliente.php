    ...
    <div class="panel-heading">
       ...
       <div class="panel-body">
         <?php foreach($clientes as $row): ?>
          <form role="form" method="post" action="/Fajas-RosyWar/index.php/modificar_cliente">
                    <label>ID: </label>
                ...
                <button class="btn btn-success" id="Enviar"><span class="glyphicon glyphicon-share-alt"></span> Editar</button>
